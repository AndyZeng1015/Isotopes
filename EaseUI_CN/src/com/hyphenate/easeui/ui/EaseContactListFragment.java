...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    protected void initView() {
        ...
        //添加好友按钮 
        ImageView iv_right = (ImageView) titleBar.getRightLayout().findViewById(R.id.right_image);
        iv_right.setImageResource(R.drawable.add_friend);
        //点击添加好友按钮
        ...
        if(onItemLongClickListener != null){
        	listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
						int arg2, long arg3) {
					// TODO Auto-generated method stub
					EaseUser user = (EaseUser)listView.getItemAtPosition(arg2);
					onItemLongClickListener.itemLongClick(user);
					return true;
				}
			});
        }
    ...
    public void refresh(Map<String, EaseUser> users){
    ...
    protected void getContactList(Map<String, EaseUser> conMap) {
        contactList.clear();
        if(conMap == null){
            return;
        }
        synchronized (this.contactsMap) {
            Iterator<Entry<String, EaseUser>> iterator = conMap.entrySet().iterator();
            List<String> blackList = EMClient.getInstance().contactManager().getBlackListUsernames();
            while (iterator.hasNext()) {
                Entry<String, EaseUser> entry = iterator.next();
                // to make it compatible with data in previous version, you can remove this check if this is new app
    ...
    public interface OnItemLongClickListener{
    	void itemLongClick(EaseUser user);
    }
}
